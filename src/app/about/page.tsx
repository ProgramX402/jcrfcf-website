    ...
    <>
      ...
      <section className="py-16 bg-white text-center">
        ...
        >
          ...
          <p className="text-lg max-w-6xl mx-auto text-gray-700 leading-relaxed text-justify">
      ...
      <section className="py-16 bg-green-700 text-white text-center">
        ...
        >
          ...
          <p className="text-lg leading-relaxed">
            A community where every vulnerable child is provided care, love, all-round development,
            and transitioned into a supportive family and responsible adulthood.
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-16 bg-white text-center">
        ...
        >
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            ...
            skills in a safe and nurturing environment, fostering responsibility and self-reliance
        ...
        <div className="container mx-auto px-6 md:px-12 max-w-7xl">
          ...
          >
            {[
              {
                title: "Love",
                text: "We embody the selfless, sacrificial, and unconditional love that God has for humanity...",
              },
              {
                title: "Teamwork",
                text: "We strongly believe that collaborative effort should be made by staff, caregivers and children...",
              },
              {
                title: "Empathy",
                text: "We honor each child’s unique story with empathy and care. Every child and staff member are valued...",
              },
            ].map((value, idx) => (
              <motion.div
                key={idx}
            ...
            {[
              {
                ...
                text: "We lead by example, demonstrating faithful stewardship of our resources, time, and talents...",
              },
              {
                title: "Relationship with Christ",
                text: "We are committed to nurturing a deep and personal faith in Jesus Christ...",
              },
            ].map((value, idx) => (
              <motion.div
                key={idx}
